"use client";
import { statusCard } from "@/src/entities/task";
import type { TStatusType } from "@/src/entities/task";
import { updateTaskStatusDb } from "@/src/features/task/change-status";
import { useTaskStore } from "@/src/shared/api";
import { playSound } from "@/src/shared/lib";
import { Confetti } from "@/src/shared/ui";
